...
const layout = [
    {
        heading: '## Hosting mode',
        description: `Your site must be served (hosted) before the extension can scan it, choose from [URL mode](#url) or [Static site mode](#static-site).`,
        inputs: [],
    },
    {
        heading: '### URL',
