...
export const disclaimerText = `The Accessibility Insights Service ran a set of automated checks to help find some of the most common accessibility issues. The best way to evaluate web accessibility compliance is to complete an ${assessmentLink} using ${webToolLink}, a free and open source dev tool that walks you through assessing a website for ${wcag21AALink} coverage`;
