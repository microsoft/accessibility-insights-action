...
export const checkRunSummaryMd = `The Accessibility Insights Service ran a set of automated checks to help find some of the most common accessibility issues. The best way to evaluate web accessibility compliance is to complete a ['WCAG 2.1 compliance assessment'](http://aka.ms/AccessibilityInsights).`;
