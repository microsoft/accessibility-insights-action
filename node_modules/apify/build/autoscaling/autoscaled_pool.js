...
class AutoscaledPool {
     ...
     */
    constructor(options = {}) {
        const { maxConcurrency = 1000, minConcurrency = 1, desiredConcurrency, desiredConcurrencyRatio = 0.90, scaleUpStepRatio = 0.05, scaleDownStepRatio = 0.05, maybeRunIntervalSecs = 0.5, loggingIntervalSecs = 60, autoscaleIntervalSecs = 10, runTaskFunction, isFinishedFunction, isTaskReadyFunction, systemStatusOptions, snapshotterOptions, log = utils_log_1.default, } = options;
