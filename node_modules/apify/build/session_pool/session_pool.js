...
class SessionPool extends events_1.EventEmitter {
     ...
     */
    constructor(options = {}) {
        const { maxPoolSize = 1000, persistStateKeyValueStoreId = null, persistStateKey = 'SDK_SESSION_POOL_STATE', createSessionFunction = null, sessionOptions = {}, log = utils_log_1.default, } = options;
        super();
        // Validation
