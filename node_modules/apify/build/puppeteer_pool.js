...
class PuppeteerPool {
    ...
    constructor(options = {}) {
        ...
        maxOpenPagesPerInstance = 50, retireInstanceAfterRequestCount = 100, launchPuppeteerFunction = launchPuppeteerOptions => puppeteer_1.launchPuppeteer(launchPuppeteerOptions), puppeteerOperationTimeoutSecs = 15, instanceKillerIntervalMillis, instanceKillerIntervalSecs = 60, killInstanceAfterMillis, killInstanceAfterSecs = 300, launchPuppeteerOptions, recycleDiskCache = false, useIncognitoPages = false, proxyConfiguration, useLiveView = false, sessionPool, log = utils_log_1.default, } = options;
        ...
        utils_1.checkParamOrThrow(proxyConfiguration, 'options.sessionPool', 'Maybe Object');
