...
declare class SystemStatus {
     ...
     * @ignore
     */
    _isMemoryOverloaded(sampleDurationMillis: number): object;
    /**
     * Returns an object with an isOverloaded property set to true
     ...
     * @ignore
     */
    _isEventLoopOverloaded(sampleDurationMillis: number): object;
    /**
     * Returns an object with an isOverloaded property set to true
     ...
     * @ignore
     */
    _isCpuOverloaded(sampleDurationMillis: number): object;
    /**
     * Returns an object with an isOverloaded property set to true
     ...
     * @ignore
     */
    _isSampleOverloaded(sample: any[], ratio: number): object;
}
