...
function Get-ConfigObject([string]$codeBaseAdmins,[string]$notificationAliases,[string]$instanceUrl,[string]$projectName,[string]$areaPath,[string]$iterationPath,[string]$tools)
{
    ...
    $config = @{}
    $config | Add-Member -Name "codebaseName"        -Type NoteProperty "accessibility-insights-action"
    $config | Add-Member -Name "repositoryName"      -Type NoteProperty "accessibility-insights-action"
